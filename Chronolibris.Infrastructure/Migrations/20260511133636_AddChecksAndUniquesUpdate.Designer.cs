...
namespace Chronolibris.Infrastructure.Migrations
{
    ...
    [Migration("20260511133636_AddChecksAndUniquesUpdate")]
    partial class AddChecksAndUniquesUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Chronolibris.Infrastructure.Data.User", b =>
                {
                    ...
                    b.ToTable("users", null, t =>
                        {
                            t.HasCheckConstraint("ck_users_first_name_correct_length", "LENGTH(TRIM(first_name))>0 AND LENGTH(TRIM(first_name))<65");

                            t.HasCheckConstraint("ck_users_last_name_correct_length", "LENGTH(TRIM(last_name))>0 AND LENGTH(TRIM(last_name))<65");

                            t.HasCheckConstraint("ck_users_user_name_correct_length", "LENGTH(TRIM(user_name))>4 AND LENGTH(TRIM(user_name))<33");
                        });
                });
