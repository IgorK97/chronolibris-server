...
namespace Chronolibris.Infrastructure.Migrations
{
    ...
    [Migration("20260319063248_AddModerationTaskChangeReport")]
    partial class AddModerationTaskChangeReport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Chronolibris.Domain.Entities.ModerationTask", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_moderation_task");

                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_moderation_task_status_id");

                    b.ToTable("moderation_task", (string)null);
                });
            ...
            modelBuilder.Entity("Chronolibris.Domain.Entities.ModerationTask", b =>
                {
                    b.HasOne("Chronolibris.Domain.Entities.ReportStatus", "Status")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_moderation_task_report_statuses_status_id");
            ...
            modelBuilder.Entity("Chronolibris.Domain.Entities.Report", b =>
                {
                    b.HasOne("Chronolibris.Domain.Entities.ModerationTask", "ModerationTask")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_reports_moderation_task_moderation_task_id");
