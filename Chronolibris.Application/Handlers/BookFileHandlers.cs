...
namespace Chronolibris.Application.Handlers
{
    ...
    public class UploadBookFileHandler : IRequestHandler<UploadBookFileCommand, long>
    {
        ...
        //    // Проверка: существует ли уже файл такого формата для этой книги
        //    var existingFile = await _bookFileRepository.GetByBookIdAndFormatIdAsync(
        //        request.BookId, request.FormatId, cancellationToken);
        ...
        //    // Создаём запись BookFile со статусом PENDING (1)
        //    var bookFile = new BookFile
        //    {
        //        Id=0,
        //        BookId = request.BookId,
        //        FormatId = request.FormatId,
        //        StorageUrl = string.Empty, // Будет обновлён после загрузки
        ...
        //    try
        //    {
        //        using var stream = request.File;
        //        var storageUrl = $"books/{bookFile.BookId}/files/{bookFile.Id}_{request.File.FileName}";

        //        await _bookStorage.SaveBookSourceAsync(
        //            bookFile.BookId,
        //            stream,
        //            request.File.ContentType,
        //            cancellationToken);

        //        // Обновляем запись: статус UPLOADED (2)
        //        bookFile.StorageUrl = storageUrl;
        //        bookFile.BookFileStatusId = BookFileStatuses.UPLOADED;
        //        bookFile.CompletedAt = DateTime.UtcNow;
        ...
        //        // Запускаем фоновую задачу конвертации (если FB2)
        //        if (request.IsReadable)
        //        {
        //            await _bookConversionJob.ProcessAsync(bookFile.Id);
        //        }
        ...
        //    catch (Exception)
        //    {
        //        // При ошибке удаляем запись из БД
        //        _bookFileRepository.Delete(bookFile);
        //        await _unitOfWork.SaveChangesAsync(cancellationToken);
        //        throw;
        //    }
